...
```ts
import {...} from "https://deno.land/x/nhttp@1.1.19/lib/class-validator.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.1.19/class-validator";
```
...
import {
  Controller,
  Post,
} from "https://deno.land/x/nhttp@1.1.19/lib/controller.ts";
import {
  IsEmail,
  IsPhoneNumber,
  IsString,
  Validate,
} from "https://deno.land/x/nhttp@1.1.19/lib/class-validator.ts";
