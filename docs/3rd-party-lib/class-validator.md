...
```ts
import {...} from "https://deno.land/x/nhttp@1.3.20/lib/class-validator.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.3.20/class-validator";
```
...
import {
  Controller,
  Post,
} from "https://deno.land/x/nhttp@1.3.20/lib/controller.ts";
import {
  IsEmail,
  IsPhoneNumber,
  IsString,
  Validate,
} from "https://deno.land/x/nhttp@1.3.20/lib/class-validator.ts";
