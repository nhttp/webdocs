...
```ts
import {...} from "https://deno.land/x/nhttp@1.2.10/lib/class-validator.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.2.10/class-validator";
```
...
import {
  ...
  IsString,
  Validate,
} from "https://deno.land/x/nhttp@1.2.10/lib/class-validator.ts";
