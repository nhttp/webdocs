...
```ts
import {...} from "https://deno.land/x/nhttp@1.2.23/lib/class-validator.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.2.23/class-validator";
```
...
import {
  ...
  IsString,
  Validate,
} from "https://deno.land/x/nhttp@1.2.23/lib/class-validator.ts";
