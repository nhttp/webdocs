...
```ts
import {...} from "https://deno.land/x/nhttp@1.3.6/lib/class-validator.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.3.6/class-validator";
```
...
import {
  Controller,
  Post,
} from "https://deno.land/x/nhttp@1.3.6/lib/controller.ts";
import {
  IsEmail,
  IsPhoneNumber,
  IsString,
  Validate,
} from "https://deno.land/x/nhttp@1.3.6/lib/class-validator.ts";
