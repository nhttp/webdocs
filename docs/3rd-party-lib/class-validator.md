...
```ts
import {...} from "https://deno.land/x/nhttp@1.1.14/lib/class-validator.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.1.14/class-validator";
```
...
import {
  ...
  IsString,
  validate,
} from "https://deno.land/x/nhttp@1.1.14/lib/class-validator.ts";
