...
```ts
import {...} from "https://deno.land/x/nhttp@1.3.24/lib/class-validator.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.3.24/class-validator";
```
...
import {
  ...
  IsString,
  Validate,
} from "https://deno.land/x/nhttp@1.3.24/lib/class-validator.ts";
