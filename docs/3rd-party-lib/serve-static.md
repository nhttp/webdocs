...
```ts
import {...} from "https://deno.land/x/nhttp@1.3.23/lib/serve-static.ts";
```

#### Deno npm

```ts
import {...} from "npm:nhttp-land@1.3.23/serve-static";
```
...
import serveStatic from "https://deno.land/x/nhttp@1.3.23/lib/serve-static.ts";
