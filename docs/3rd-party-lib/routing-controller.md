...
#### Deno
```ts
import {...} from "https://deno.land/x/nhttp@1.3.25/lib/controller.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.3.25/controller";
```
#### deno.json
```js
{
...
import { Get, Controller } from "https://deno.land/x/nhttp@1.3.25/lib/controller.ts";
