...
#### Deno
```ts
import {...} from "https://deno.land/x/nhttp@1.2.21/lib/controller.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.2.21/controller";
```
#### Node / Bun
```ts
...
import { Get, Controller } from "https://deno.land/x/nhttp@1.2.21/lib/controller.ts";
