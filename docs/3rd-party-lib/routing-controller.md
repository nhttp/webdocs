...
#### Deno
```ts
import {...} from "https://deno.land/x/nhttp@1.2.24/lib/controller.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.2.24/controller";
```
#### Node / Bun
```ts
...
### Usage
```ts
import { nhttp, RequestEvent } from "https://deno.land/x/nhttp@1.2.24/mod.ts";
import { Get, Controller } from "https://deno.land/x/nhttp@1.2.24/lib/controller.ts";
