...
#### Deno
```ts
import {...} from "https://deno.land/x/nhttp@1.1.13/lib/controller.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.1.13/controller";
```
#### Node / Bun
```ts
...
### Usage
```ts
import { nhttp, RequestEvent } from "https://deno.land/x/nhttp@1.1.13/mod.ts";
import { Get, Controller } from "https://deno.land/x/nhttp@1.1.13/lib/controller.ts";
