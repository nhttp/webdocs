...
#### Deno
```ts
import {...} from "https://deno.land/x/nhttp@1.1.18/lib/controller.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.1.18/controller";
```
#### Node / Bun
```ts
...
import { Get, Controller } from "https://deno.land/x/nhttp@1.1.18/lib/controller.ts";
