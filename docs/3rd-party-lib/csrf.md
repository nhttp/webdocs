...
```ts
import {...} from "https://deno.land/x/nhttp@1.3.25/lib/csrf.ts";
```

#### Deno npm

```ts
import {...} from "npm:nhttp-land@1.3.25/csrf";
```
...
import csrf from "https://deno.land/x/nhttp@1.3.25/lib/csrf.ts";
