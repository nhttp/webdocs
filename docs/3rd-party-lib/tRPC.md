...
#### Deno
```ts
import {...} from "https://deno.land/x/nhttp@1.2.19/lib/trpc.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.2.19/trpc";
```
#### Node / Bun
```bash
npm i @trpc/server
...
import adapter from "https://deno.land/x/nhttp@1.2.19/lib/trpc.ts";
