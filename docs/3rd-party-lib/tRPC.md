...
#### Deno
```ts
import {...} from "https://deno.land/x/nhttp@1.2.9/lib/trpc.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.2.9/trpc";
```
#### Node / Bun
```bash
npm i @trpc/server
...
### Usage
```ts
import nhttp, { RequestEvent } from "https://deno.land/x/nhttp@1.2.9/mod.ts";
import adapter from "https://deno.land/x/nhttp@1.2.9/lib/trpc.ts";
