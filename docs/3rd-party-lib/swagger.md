...
```ts
import {...} from "https://deno.land/x/nhttp@1.3.10/lib/swagger.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.3.10/swagger";
```
...
```ts
import { nhttp, RequestEvent } from "https://deno.land/x/nhttp@1.3.10/mod.ts";
import {
  Controller,
  Get,
} from "https://deno.land/x/nhttp@1.3.10/lib/controller.ts";
import { 
  ApiDocument,
  ApiOperation,
  ApiResponse,
  DocumentBuilder,
  swagger, 
} from "https://deno.land/x/nhttp@1.3.10/lib/swagger.ts";
