...
```ts
import {...} from "https://deno.land/x/nhttp@1.3.17/lib/swagger.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.3.17/swagger";
```
...
```ts
import { nhttp, RequestEvent } from "https://deno.land/x/nhttp@1.3.17/mod.ts";
import {
  Controller,
  Get,
} from "https://deno.land/x/nhttp@1.3.17/lib/controller.ts";
import { 
  ApiDocument,
  ApiOperation,
  ApiResponse,
  DocumentBuilder,
  swagger, 
} from "https://deno.land/x/nhttp@1.3.17/lib/swagger.ts";
