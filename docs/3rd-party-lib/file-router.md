...
#### Deno
```ts
import {...} from "https://deno.land/x/nhttp@1.3.22/lib/file-router.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.3.22/file-router";
```
#### Node / Bun
```ts
...
```ts
// routes/index.ts
import { RequestEvent } from "https://deno.land/x/nhttp@1.3.22/mod.ts";
...
import { generateRoute } from "https://deno.land/x/nhttp@1.3.22/lib/file-router.ts";
...
```ts
import { getRouteFromDir } from "https://deno.land/x/nhttp@1.3.22/lib/file-router.ts";
