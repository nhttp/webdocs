...
#### Deno
```ts
import {...} from "https://deno.land/x/nhttp@1.3.18/lib/file-router.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.3.18/file-router";
```
#### Node / Bun
```ts
...
```ts
// routes/index.ts
import { RequestEvent } from "https://deno.land/x/nhttp@1.3.18/mod.ts";
...
import { generateRoute } from "https://deno.land/x/nhttp@1.3.18/lib/file-router.ts";
...
```ts
import { getRouteFromDir } from "https://deno.land/x/nhttp@1.3.18/lib/file-router.ts";
