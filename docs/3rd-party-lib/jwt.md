...
#### Deno
```ts
import {...} from "https://deno.land/x/nhttp@1.3.3/lib/jwt.ts";
```
#### Deno npm
```ts
import {...} from "npm:nhttp-land@1.3.3/jwt";
```
#### Node / Bun
```bash
npm i jwt-simple
...
```ts
...
import jwt from "https://deno.land/x/nhttp@1.3.3/lib/jwt.ts";
...
import validate, { z } from "https://deno.land/x/nhttp@1.3.3/lib/zod-validator.ts";
import jwt from "https://deno.land/x/nhttp@1.3.3/lib/jwt.ts";
